...
func (svc OrganizationService) UpdateOrganization(ctx context.Context, org entities.Organization, organizationID string) error {
	err := svc.repo.UpdateOrganization(ctx, org, organizationID)
	return err
}
